        ...
        if (claims.iss === ctx.oidc.client.clientId) {
            ...
            if (  typeof jwt.payload.cnf === "object") {
                ...
                if (cnf &&
                    ...
                    debug("client info is %O", ctx.oidc.assertion_grant.client);
                    debug("client info is %O", ctx.oidc.assertion_grant.sub.claims());
                    ...
                    const clientInfo = {
                        ...
                        "client_secret": "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" // generate random secret
